...
namespace WeLearn.Data.Seed
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            (
                 new Lesson { Id = 1,  VideoId = 1,  MaterialId = 1,  ApplicationUserId = UserId, IsApproved = true, CategoryId = 1,  DateCreated = DateTime.UtcNow, Name = "Pronouns, types", Description = "A lecture about pronouns and when to use them." },
                 new Lesson { Id = 2,  VideoId = 2,  MaterialId = 2,  ApplicationUserId = UserId, IsApproved = true, CategoryId = 2,  DateCreated = DateTime.UtcNow, Name = "Prime numbers", Description = "A natural number greater than 1 that is not a product of two smaller natural numbers." },
                 new Lesson { Id = 3,  VideoId = 3,  MaterialId = 3,  ApplicationUserId = UserId, IsApproved = true, CategoryId = 3,  DateCreated = DateTime.UtcNow, Name = "Developing with C#", Description = "About the C# language and the .NET development Platform. First steps." },
                 new Lesson { Id = 4,  VideoId = 4,  MaterialId = 4,  ApplicationUserId = UserId, IsApproved = true, CategoryId = 4,  DateCreated = DateTime.UtcNow, Name = "Excel", Description = "Data analysis." },
                 new Lesson { Id = 5,  VideoId = 5,  MaterialId = 5,  ApplicationUserId = UserId, IsApproved = true, CategoryId = 5,  DateCreated = DateTime.UtcNow, Name = "Ukraine, Eastern Europe", Description = "Eastern European Countries. Their iconomic growth and political stances. Ukraine." },
                 new Lesson { Id = 6,  VideoId = 6,  MaterialId = 6,  ApplicationUserId = UserId, IsApproved = true, CategoryId = 6,  DateCreated = DateTime.UtcNow, Name = "Football", Description = "Kicking a ball on the field." },
                 new Lesson { Id = 7,  VideoId = 7,  MaterialId = 7,  ApplicationUserId = UserId, IsApproved = true, CategoryId = 7,  DateCreated = DateTime.UtcNow, Name = "William Shakespere's 106 sonnet", Description = "A peek into Shakespere's art." },
                 new Lesson { Id = 8,  VideoId = 8,  MaterialId = 8,  ApplicationUserId = UserId, IsApproved = true, CategoryId = 8,  DateCreated = DateTime.UtcNow, Name = "Human rights", Description = "A lecture about rights of the people." },
                 new Lesson { Id = 9,  VideoId = 9,  MaterialId = 9,  ApplicationUserId = UserId, IsApproved = true, CategoryId = 9,  DateCreated = DateTime.UtcNow, Name = "Modal verbs", Description = "We use modals to show if we believe something is certain, possible or impossible." },
                 new Lesson { Id = 10, VideoId = 10, MaterialId = 10, ApplicationUserId = UserId, IsApproved = true, CategoryId = 10, DateCreated = DateTime.UtcNow, Name = "Verbs of motion", Description = "A lecture about the verbs of motion and when to use them." },
                 new Lesson { Id = 11, VideoId = 11, MaterialId = 11, ApplicationUserId = UserId, IsApproved = true, CategoryId = 11, DateCreated = DateTime.UtcNow, Name = "Peek in the past", Description = "A brief peek into our ancestors' life." },
                 new Lesson { Id = 12, VideoId = 12, MaterialId = 12, ApplicationUserId = UserId, IsApproved = true, CategoryId = 12, DateCreated = DateTime.UtcNow, Name = "Cells. Prokaryotic and Eukaryotic", Description = "A lesson about the different types of cells and their differences." },
                 new Lesson { Id = 13, VideoId = 13, MaterialId = 13, ApplicationUserId = UserId, IsApproved = true, CategoryId = 13, DateCreated = DateTime.UtcNow, Name = "Acids, Bases and pH", Description = "A lesson about acids, they effects on the environtment and usage cases." },
                 new Lesson { Id = 14, VideoId = 14, MaterialId = 14, ApplicationUserId = UserId, IsApproved = true, CategoryId = 14, DateCreated = DateTime.UtcNow, Name = "Popular music", Description = "Genres, instruments and notation." },
                 new Lesson { Id = 15, VideoId = 15, MaterialId = 15, ApplicationUserId = UserId, IsApproved = true, CategoryId = 15, DateCreated = DateTime.UtcNow, Name = "Painting", Description = "Pigments, brushes, bases, matrices." },
                 new Lesson { Id = 16, VideoId = 16, MaterialId = 16, ApplicationUserId = UserId, IsApproved = true, CategoryId = 16, DateCreated = DateTime.UtcNow, Name = "Entrepreneurship", Description = "Creating a new business, bearing most of the risks and enjoying most of the rewards." }
             );
