...
namespace WeLearn.Data.Infrastructure
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            const string userId = GlobalConstants.SystemRegularAdministratorId;
            ApplicationUser user = new ApplicationUser
            {
                Id = userId,
                Email = GlobalConstants.SystemRegularAdministratorEmail,
                EmailConfirmed = false,
                NormalizedEmail = GlobalConstants.SystemRegularAdministratorEmail.ToUpper(),
                UserName = GlobalConstants.SystemRegularAdministratorUsername,
                NormalizedUserName = GlobalConstants.SystemRegularAdministratorUsername.ToUpper(),
            };

            PasswordHasher<ApplicationUser> passwordHasher = new PasswordHasher<ApplicationUser>();
            user.PasswordHash = passwordHasher.HashPassword(user, "User_qwerty_1234%");
            ...
            modelBuilder.Entity<Comment>().HasData(
                new Comment
                {
                    Id = 1, CreatedOn = dateTime, UserId = userId, Content = "I like it!",
                    LessonId = 1
                },
                new Comment
                {
                    Id = 2, CreatedOn = dateTime, UserId = userId,
                    Content = "The teacher is awesome.",
                    LessonId = 2
                },
                new Comment
                {
                    Id = 3, CreatedOn = dateTime, UserId = userId, Content = "This is just great.",
                    LessonId = 3
                });
            ...
            modelBuilder.Entity<Report>().HasData(
                new Report
                {
                    Id = 1, UserId = userId, CreatedOn = dateTime, LessonId = 5,
                    Subject = "The language used in title", Description = "Bad language in lesson's title."
                },
                new Report
                {
                    Id = 3, UserId = userId, CreatedOn = dateTime, CommentId = 1,
            ...
            modelBuilder.Entity<Lesson>().HasData(
                new Lesson
                {
                    Id = 1, VideoId = 1, MaterialId = 1, UserId = userId, CreatedOn = dateTime,
                ...
                new Lesson
                {
                    Id = 2, VideoId = 2, MaterialId = 2, UserId = userId, CreatedOn = dateTime,
                ...
                new Lesson
                {
                    Id = 3, VideoId = 3, MaterialId = 3, UserId = userId, CreatedOn = dateTime,
                ...
                new Lesson
                {
                    Id = 4, VideoId = 4, MaterialId = 4, UserId = userId, CreatedOn = dateTime,
                    IsApproved = true, CategoryId = 4, Grade = Grade.Fourth, Name = "Excel",
                    Description = "Data analysis."
                },
                new Lesson
                {
                    Id = 5, VideoId = 5, MaterialId = 5, UserId = userId, CreatedOn = dateTime,
                ...
                new Lesson
                {
                    Id = 6, VideoId = 6, MaterialId = 6, UserId = userId, CreatedOn = dateTime,
                    IsApproved = true, CategoryId = 6, Grade = Grade.Sixth, Name = "Football",
                    Description = "Kicking a ball on the field."
                },
                new Lesson
                {
                    Id = 7, VideoId = 7, MaterialId = 7, UserId = userId, CreatedOn = dateTime,
                ...
                new Lesson
                {
                    Id = 8, VideoId = 8, MaterialId = 8, UserId = userId, CreatedOn = dateTime,
                    IsApproved = true, CategoryId = 8, Grade = Grade.Eighth, Name = "Human rights",
                    Description = "A lecture about rights of the people."
                },
                new Lesson
                {
                    Id = 9, VideoId = 9, MaterialId = 9, UserId = userId, CreatedOn = dateTime,
                ...
                new Lesson
                {
                    Id = 10, VideoId = 10, MaterialId = 10, UserId = userId, CreatedOn = dateTime,
                ...
                new Lesson
                {
                    Id = 11, VideoId = 11, MaterialId = 11, UserId = userId, CreatedOn = dateTime,
                    IsApproved = true, CategoryId = 11, Grade = Grade.Eleventh, Name = "Peek in the past",
                    Description = "A brief peek into our ancestors' life."
                },
                new Lesson
                {
                    Id = 12, VideoId = 12, MaterialId = 12, UserId = userId, CreatedOn = dateTime,
                ...
                new Lesson
                {
                    Id = 13, VideoId = 13, MaterialId = 13, UserId = userId, CreatedOn = dateTime,
            ...
            modelBuilder.Entity<ChatUser>().HasData(
                new ChatUser { UserId = userId, ChatId = 1 });
        }
    }
}
