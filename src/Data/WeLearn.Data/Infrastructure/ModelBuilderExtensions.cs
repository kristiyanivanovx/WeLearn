    ...
    public static class ModelBuilderExtensions
    {
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Comment>().HasData(
                new Comment
                {
                    Id = 1, CreatedOn = DateTime.UtcNow, ApplicationUserId = userId, Content = "I like it!",
                    LessonId = 1
                },
                new Comment
                {
                    Id = 2, CreatedOn = DateTime.UtcNow, ApplicationUserId = userId,
                    Content = "The teacher is awesome.",
                    LessonId = 2
                },
                new Comment
                {
                    Id = 3, CreatedOn = DateTime.UtcNow, ApplicationUserId = userId, Content = "This is just great.",
                    LessonId = 3
                });
            ...
            modelBuilder.Entity<Report>().HasData(
                new Report
                {
                    Id = 1, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow, LessonId = 5,
                    Subject = "The language used in title", Description = "Bad language in lesson's title."
                },
                new Report
                {
                    Id = 3, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow, CommentId = 1,
            ...
            modelBuilder.Entity<Lesson>().HasData(
                new Lesson
                {
                    Id = 1, VideoId = 1, MaterialId = 1, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                ...
                new Lesson
                {
                    Id = 2, VideoId = 2, MaterialId = 2, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                ...
                new Lesson
                {
                    Id = 3, VideoId = 3, MaterialId = 3, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                ...
                new Lesson
                {
                    Id = 4, VideoId = 4, MaterialId = 4, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                    IsApproved = true, CategoryId = 4, Grade = Grade.Fourth, Name = "Excel",
                    Description = "Data analysis."
                },
                new Lesson
                {
                    Id = 5, VideoId = 5, MaterialId = 5, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                ...
                new Lesson
                {
                    Id = 6, VideoId = 6, MaterialId = 6, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                    IsApproved = true, CategoryId = 6, Grade = Grade.Sixth, Name = "Football",
                    Description = "Kicking a ball on the field."
                },
                new Lesson
                {
                    Id = 7, VideoId = 7, MaterialId = 7, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                ...
                new Lesson
                {
                    Id = 8, VideoId = 8, MaterialId = 8, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                    IsApproved = true, CategoryId = 8, Grade = Grade.Eighth, Name = "Human rights",
                    Description = "A lecture about rights of the people."
                },
                new Lesson
                {
                    Id = 9, VideoId = 9, MaterialId = 9, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                ...
                new Lesson
                {
                    Id = 10, VideoId = 10, MaterialId = 10, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                ...
                new Lesson
                {
                    Id = 11, VideoId = 11, MaterialId = 11, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                    IsApproved = true, CategoryId = 11, Grade = Grade.Eleventh, Name = "Peek in the past",
                    Description = "A brief peek into our ancestors' life."
                },
                new Lesson
                {
                    Id = 12, VideoId = 12, MaterialId = 12, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                ...
                new Lesson
                {
                    Id = 13, VideoId = 13, MaterialId = 13, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                ...
                new Lesson
                {
                    Id = 14, VideoId = 14, MaterialId = 14, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                    IsApproved = true, CategoryId = 14, Grade = Grade.Fifth, Name = "Popular music",
                    Description = "Genres, instruments and notation."
                },
                new Lesson
                {
                    Id = 15, VideoId = 15, MaterialId = 15, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
                    IsApproved = true, CategoryId = 15, Grade = Grade.First, Name = "Painting",
                    Description = "Pigments, brushes, bases, matrices."
                },
                new Lesson
                {
                    Id = 16, VideoId = 16, MaterialId = 16, ApplicationUserId = userId, CreatedOn = DateTime.UtcNow,
            ...
            modelBuilder.Entity<Material>().HasData(
                new Material
                {
                    Id = 1, LessonId = 1, CreatedOn = DateTime.UtcNow, Name = "Teaching",
                    Link =
                ...
                new Material
                {
                    Id = 2, LessonId = 2, CreatedOn = DateTime.UtcNow, Name = "Teaching",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 3, LessonId = 3, CreatedOn = DateTime.UtcNow, Name = "Coding",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 4, LessonId = 4, CreatedOn = DateTime.UtcNow, Name = "Office Suite",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 5, LessonId = 5, CreatedOn = DateTime.UtcNow, Name = "Ukraine",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 6, LessonId = 6, CreatedOn = DateTime.UtcNow, Name = "Football",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 7, LessonId = 7, CreatedOn = DateTime.UtcNow, Name = "Literature",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 8, LessonId = 8, CreatedOn = DateTime.UtcNow, Name = "Human Rights",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 9, LessonId = 9, CreatedOn = DateTime.UtcNow, Name = "Modal Verbs",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 10, LessonId = 10, CreatedOn = DateTime.UtcNow, Name = "Russian Language",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 11, LessonId = 11, CreatedOn = DateTime.UtcNow, Name = "History",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 12, LessonId = 12, CreatedOn = DateTime.UtcNow, Name = "Biology",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 13, LessonId = 13, CreatedOn = DateTime.UtcNow, Name = "Chemistry",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 14, LessonId = 14, CreatedOn = DateTime.UtcNow, Name = "Music",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 15, LessonId = 15, CreatedOn = DateTime.UtcNow, Name = "Painting",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                },
                new Material
                {
                    Id = 16, LessonId = 16, CreatedOn = DateTime.UtcNow, Name = "Entrepreneurship",
                    Link =
                        "https://res.cloudinary.com/dgvfqp9zu/raw/upload/v1620309301/welearn-asp-net-core-app/zip-files/seed-dfd1-4ed3-a862-684cd9a35995_mdzu3z.zip"
                });
