...
{
    public class CommentReportEditModel : IMapFrom<Data.Models.LessonModule.Report>, IHaveCustomMappings
    {
        ...
        {
            configuration.CreateMap<Data.Models.LessonModule.Report, CommentReportEditModel>()
