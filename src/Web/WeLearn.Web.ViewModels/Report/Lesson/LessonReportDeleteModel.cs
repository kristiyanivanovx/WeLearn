...
{
    public class LessonReportDeleteModel : IMapFrom<Data.Models.LessonModule.Report>, IHaveCustomMappings
    {
        ...
        {
            configuration.CreateMap<Data.Models.LessonModule.Report, LessonReportDeleteModel>()
